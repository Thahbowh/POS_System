...
// ─── 3. Serve static frontend files (Development only) ─────────
...
// ─── 6. Serve index.html for all non-API routes (Development only) ─────────
if (process.env.NODE_ENV !== 'production') {
...
try {
  ...
  console.warn('  Could not load cert.pem/key.pem — falling back to plain HTTP.');
